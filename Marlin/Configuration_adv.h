...
//#endif
  ...
  #else
    #define CASE_LIGHT_PIN P1_26   // Override the default pin if needed  (Y+ PIN SKR1.3)
  #endif
...
//#define LCD_SHOW_E_TOTAL
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_GCODE_DEFAULT_SORT_ALPHA false // do not really sort unil cmd
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      455  // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   455  // (mm) Load length of filament, from extruder gear to nozzle. ДЛЯ КОРОТКОЙ ТРУБКИ НА КАЧАЮЩЕМСЯ ЭКСТРУДЕРЕ
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
  ...
  #define INTERPOLATE       true  // Interpolate X/Y/Z_MICROSTEPS to 256 Включает или выключает интерполяцию по ВСЕМ осям
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       1000        // (mA) RMS current. Multiply by 1.414 for peak current. сюда пишем наш ток Irms, который мы посчитали ранее
    ...
    #define E0_CURRENT      300 //Sherpa Mini Extruder Nema 14 LDO up max 350
    #define E0_MICROSTEPS    16
