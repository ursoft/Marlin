# Замечание от ursoft
Данный форк создан 19.11.2019 и служит для отражения конфигурации и различных улучшений к принтеру [Ulti Steel](http://ulti-steel.ru/).
По мере разработки (в отличие от выглядящего не сильно активным форка [BIGTREETECH-SKR-V1.3](https://github.com/bigtreetech/BIGTREETECH-SKR-V1.3)) сюда будут интегрироваться изменения источника - но это зависит от того, увижу ли я здесь активность от владельцев Ulti Steel и/или его производителей (официального статуса данный проект не имеет). Добро пожаловать.
...
The current Marlin dev team consists of:
 ...
 - JoГЈo Brazio [[@jbrazio](https://github.com/jbrazio)] - Portugal
